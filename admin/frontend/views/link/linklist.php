...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>友情链接管理 - 龙头后台管理系统</title>
		<meta name="keywords" content="友情链接管理 - 龙头后台管理系统" />
		<meta name="description" content="友情链接管理 - 龙头后台管理系统" />
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>友情链接编号</th>
														<th>友情链接名称</th>
														<th class="hidden-480">友情链接路径</th>

														<th>友情链接状态</th>
														<th class="hidden-480">友情链接排行</th>
														<th></th>
													</tr>
												</thead>
