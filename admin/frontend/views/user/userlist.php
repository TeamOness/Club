											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>用户编号</th>
														<th>用户姓名</th>
														<th class="hidden-480">用户住址</th>
														<th>
															用户类型
														</th>
														<th class="hidden-480">用户电话</th>
												...
												<?php foreach($list as $v) { ?>
													<tr>
														...
														<td class="hidden-480"><?php echo $v['user_address']; ?></td>
														<td><?php if($v['user_type'] == 1) {echo "车主";}else{echo "买家";} ?></td>

														<td class="hidden-480">
															<?php echo $v['user_phone']; ?>
														</td>
