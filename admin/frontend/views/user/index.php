...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>登录 - 龙头二手车后台管理系统</title>
		<meta name="keywords" content="头二手车后台管理系统" />
		<meta name="description" content="头二手车后台管理系统" />
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">龙头</span>
									<span class="white">二手车</span>
								</h1>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form method="post" action="index.php?r=login/index">
												<fieldset>
													...
													<div class="clearfix">
														...
														<!-- <button type="submit" class="width-35 pull-right btn btn-sm btn-primary"></button> -->
														<i class="icon-key"></i>
											...
											<div class="social-or-login center">
												<span class="bigger-110">龙头管理系统</span>
											</div>
