											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php foreach($details as $v) {?>
													<tr>
														...
														<td><?php echo $v['details_id']; ?></td>
														<td><?php foreach($v['user'] as $u){ echo $u['user_name'];} ?></td>
														<td class="hidden-480"><?php foreach($v['brand'] as $b){ echo $b['brand_name'];} ?></td>
														<td><?php if($v['details_state'] == 1){echo "已售出";}else{echo "销售中";}?></td>

														<td class="hidden-480"><?php echo $v['details_address']; ?></td>
