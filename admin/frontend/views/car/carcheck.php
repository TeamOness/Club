							...
							<div class="col-xs-12">
								...
								<?php
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车主 </label>
										<div class="col-xs-12 col-sm-4">
											<select class="form-control" id="form-field-select-1" name="user_id">
												<option value="请选择车主">请选择车主</option>
									...
									<div class="form-group">
										...
										<div class="col-xs-12 col-sm-4">
											<select class="form-control" id="form-field-select-1" name="brand_id">
									...
									<!-- <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车系 </label>
										<div class="col-xs-12 col-sm-4">
											<select class="form-control" id="form-field-select-1" name="brand_id">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车辆款式 </label>
										<div class="col-xs-12 col-sm-4">
											<select class="form-control" id="form-field-select-1" name="details_time">
												<option value="请选择款式">请选择款式</option>
												<option value="2010款">2010款</option>
												<option value="2011款">2011款</option>
												<option value="2012款">2012款</option>
												<option value="2013款">2013款</option>
												<option value="2014款">2014款</option>
												<option value="2015款">2015款</option>
												<option value="2016款">2016款</option>
											</select>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车辆耗油量 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="耗油量 L/KM" name="details_oil" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 车辆载重 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="车辆载重" name="details_weight" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车辆变速箱 </label>
										<div class="col-xs-12 col-sm-4">
											<select class="form-control" id="form-field-select-1" name="details_move">
												<option value="请选择变速箱">请选择变速箱</option>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 车辆版式 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="车辆版式" name="details_type" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 车主报价 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="车主报价" name="details_price" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 新车价 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="新车价" name="details_first" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 车辆上牌时间 </label>

										<div class="col-sm-9">
											<div class="input-group">
												<input class="form-control input-mask-date" type="text" id="form-field-mask-1" name="details_brandtime" />
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车辆上牌地点 </label>
										<div class="col-xs-12 col-sm-4">
											<select class="form-control" id="form-field-select-1" name="details_address">
												<option value="请选择车辆上牌地点">请选择车辆上牌地点</option>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 车辆里程 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-2" placeholder="车辆里程  万公里" name="details_mial" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车辆排放标准 </label>
										<div class="col-xs-12 col-sm-4">
											<select class="form-control" id="form-field-select-1" name="details_standard">
												<option value="请选择车辆排放标准">请选择车辆排放标准</option>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 车辆简介 </label>
										<div class="col-xs-12 col-sm-4">
											<div>
												<textarea class="form-control" id="form-field-8" name="details_introduction" placeholder="车辆简介"></textarea>
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 年检到期时间 </label>

										<div class="col-sm-9">
											<div class="input-group">
												<input class="form-control input-mask-date" type="text" id="form-field-mask-1" name="details_year" />
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 交强险到期时间 </label>

										<div class="col-sm-9">
											<div class="input-group">
												<input class="form-control input-mask-date" type="text" id="form-field-mask-1" name="details_insurance" />
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 商业险到期时间 </label>

										<div class="col-sm-9">
											<div class="input-group">
												<input class="form-control input-mask-date" type="text" id="form-field-mask-1" name="details_commercial" />
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 过户次数 </label>
										<div class="col-sm-4">
											<input type="text" name="details_number" class="input-mini" id="spinner3" />
										</div>
									</div>
