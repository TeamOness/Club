						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 检测师性别 </label>
									...
									<!-- <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 检测师照片 </label>
										<div class="col-sm-4">
											<input type="file" name='division_img' id="id-input-file-2" />
										</div>
									</div>
