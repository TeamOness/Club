											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>检测师编号</th>
														<th>检测师姓名</th>
														<th class="hidden-480">检测师级别</th>

														<th>检测师住址</th>
														<th class="hidden-480">检测师电话</th>
												...
												<?php foreach($arr as $v){?>
													<tr>
														...
														<td class="hidden-480"><?php echo $v['division_level']; ?></td>
														<td><?php echo $v['division_address']; ?></td>

														<td class="hidden-480"><?php echo $v['division_phone']; ?></td>

														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="green" href="index.php?r=check/modify&id=<?php echo $v['division_id']; ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="index.php?r=check/del&id=<?php echo $v['division_id']; ?>">
...
<![endif]-->
		...
		<script src="<?php echo Yii::$app->request->baseUrl; ?>/assets/js/jquery.dataTables.min.js"></script>
		<script src="<?php echo Yii::$app->request->baseUrl; ?>/assets/js/jquery.dataTables.bootstrap.js"></script>
